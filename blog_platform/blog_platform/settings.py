...
SECRET_KEY = 'django-insecure-y#+9us672b*-)n0fimt)d*yx3g+is5d_vs1t8%a2go%ka!#223'
...
# Configure media settings for profile pictures
MEDIA_URL = '/media/'
...
SIMPLE_JWT = {
    ...
    'AUTH_HEADER_TYPES': ('Bearer',),  # Auth header type
